...
vm_description = "Clean Windows 10 Image for Capturing AppStacks, which is a identical copy of W10X64ICGIxx, but without Horizon Agent, DEM Agent, Windows Defender disabled and Windows Firewall disabled."

# The username of the new local administator account.
localvdiadmin = "LocalVDIadmin"

# App Volumes Capture Active Directory Organizational Unit
appvolcapou = ""
