...
# Build section
build {
  sources = ["source.vsphere-iso.windows-11",]
  ...
  provisioner "powershell" {
    ...
    environment_vars = [
      ...
      "w11_startlayout_dirname=${var.w11_startlayout_dirname}",
      "w11_startlayout_xmlfile=${var.w11_startlayout_xmlfile}",
    ...
    scripts = [
      ...
      "./http/scripts/windows/vdi/stage3/301_Import_W11_StartLayout.ps1",
