...
# Source section
source "vsphere-iso" "windows-10-appvolcap" {
...
# Build section
build {
  sources = ["source.vsphere-iso.windows-10-appvolcap",]
  ...
  provisioner "powershell" {
    ...
    scripts = [
      ...
      "./http/scripts/windows/capture/102_Hide_All_Items_In_Sec_Center.ps1",
      ...
      "./http/scripts/windows/capture/106_Uninstall_Built-in_OneDrive.ps1",
  ...
  # STAGE 3) HORIZON SUITE CONFIG & AGENTS ETC.
  provisioner "file" {
  ...
  provisioner "file" {
    source = "./http/files/domjoin/DOMJOIN.pwd"
    destination = "${var.psfunction_path}\\DOMJOIN.pwd"
  }
  ...
  provisioner "powershell" {
    ...
    environment_vars = [
      ...
      "sadomjoin=${var.sadomjoin}",
      "domainname=${var.domainname}",
      "appvolcapou=${var.appvolcapou}",
    ]
    scripts = [
      ...
      "./http/scripts/windows/capture/316_Add_AppVolCapVM_to_Domain.ps1",
    ]
  }
