Param(
  ...
  [string]$env:w10_startlayout_dirname,
  [string]$env:w10_startlayout_xmlfile,
  [string]$env:username,
...
Copy-Item -Path "$env:softwarerepo\$env:w10_startlayout_dirname\$env:w10_startlayout_xmlfile" -Destination "C:\Users\Default\AppData\Local\Microsoft\Windows\Shell" -Force | Out-Null
